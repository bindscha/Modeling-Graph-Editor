...
import com.zeus.graph.editor.CustomEditorAboutFrame;
import com.zeus.graph.editor.CustomEditorMenuBar;
import com.zeus.graph.editor.CustomEditorPopupMenu;
import com.zeus.graph.editor.CustomEditorToolBar;
...
public class GraphEditor extends BasicGraphEditor
{
	...
	private static final MediaSize DEFAULT_PAGE_SIZE = MediaSize.ISO.A3;
	public static final double DEFAULT_PAGE_WIDTH = DEFAULT_PAGE_SIZE.getY(MediaSize.MM);
	public static final double DEFAULT_PAGE_HEIGHT = DEFAULT_PAGE_SIZE.getX(MediaSize.MM);
	...
	public GraphEditor()
	{
		this("Zeus Dependency Graph Editor", new CustomGraphComponent(new CustomGraph()));
	}
	...
	public GraphEditor(String appTitle, mxGraphComponent component)
	{
		...
		graph = (CustomGraph) graphComponent.getGraph();
	...
	{
		add(new CustomEditorToolBar(this, JToolBar.HORIZONTAL), BorderLayout.NORTH);
	}
	...
	protected void showGraphPopupMenu(MouseEvent e)
	{
		Point pt = SwingUtilities.convertPoint(e.getComponent(), e.getPoint(),
				graphComponent);
		CustomEditorPopupMenu menu = new CustomEditorPopupMenu(GraphEditor.this);
	...
	public void about()
	{
		...
		if (frame != null)
		{
			CustomEditorAboutFrame about = new CustomEditorAboutFrame(frame);
			about.setModal(true);
	...
	*/
	public static class CustomGraphComponent extends mxGraphComponent
	{
		...
		public CustomGraphComponent(mxGraph graph)
		{
			...
			setPageBackgroundColor(getBackground());
			setPageShadowColor(getPageBackgroundColor());
			
			
			
			PageFormat defaultPageFormat = getPageFormat();
			Paper defaultPaper = new Paper();
			defaultPaper.setSize(DEFAULT_PAGE_WIDTH, DEFAULT_PAGE_HEIGHT);
			defaultPageFormat.setPaper(defaultPaper);
			...
			new ZoomPolicyAction(mxGraphComponent.ZOOM_POLICY_PAGE).actionPerformed(new ActionEvent(this, 0, null));
		}
	...
	public static class CustomGraph extends mxGraph
	{
		...
		private GraphManager graphManager_;
		...
		public CustomGraph()
		{
			...
			addListener(mxEvent.CELLS_ADDED, graphManager_.insertionListener());
			addListener(mxEvent.CELLS_REMOVED, graphManager_.deletionListener());
		}
	...
	public static void main(String[] args)
	{
		...
		Resources.initialize("text_bundle", locale);
		...
		editor.createFrame(new CustomEditorMenuBar(editor)).setVisible(true);
	}
}
