...
public class CustomEditorPopupMenu extends JPopupMenu
{
	...
	public CustomEditorPopupMenu(BasicGraphEditor editor)
	{
		...
		CustomEditorMenuBar.populateFormatMenu(menu, editor);

		// Creates the shape menu
		menu = (JMenu) add(new JMenu(mxResources.get("shape")));

		CustomEditorMenuBar.populateShapeMenu(menu, editor);
